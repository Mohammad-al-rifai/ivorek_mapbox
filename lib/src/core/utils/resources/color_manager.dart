...
class ColorManager {
  // Primary Colors
  static const Color primary = Color(0xffEEC41B);
  static const Color darkPrimary = Color(0xffB7C00D);
  static const Color lightPrimary = Color(0xffF7D342); // color with 80% opacity
